...
class ServicesReceivedDataset(models.Model):
    ...
    med_svc_code = models.TextField(null=True, blank=True)
    service_date = models.DateField(max_length=255,null=True, blank=True)
    service_provider_ranking_id = models.CharField(max_length=255,null=True, blank=True)
    visit_type = models.CharField(max_length=255,null=True, blank=True)
    service_received_id = models.IntegerField(max_length=255,null=True, blank=True)
    ...
    hdr_gender = models.CharField(max_length=255,null=True, blank=True)
    ...
    cpt_description = models.CharField(max_length=255,null=True, blank=True)
    cpt_category = models.CharField(max_length=255,null=True, blank=True)
    hdr_service_provider_rankings = models.CharField(max_length=255,null=True, blank=True)
    icd10_code = models.CharField(max_length=255,null=True, blank=True)
    icd10_code_description = models.CharField(max_length=255,null=True, blank=True)
    icd10_sub_category = models.CharField(max_length=255,null=True, blank=True)
    icd10_categories = models.CharField(max_length=255,null=True, blank=True)
    icd10_chapter = models.CharField(max_length=255,null=True, blank=True)
    district_council = models.CharField(max_length=255,null=True, blank=True)
