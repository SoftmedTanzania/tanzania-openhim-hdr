...
;(function()
{
    ...
    function Brush()
    {
        ...
        this.regexList = [
            ...
            { regex: new RegExp(this.getKeywords(funcs), 'gmi'),        css: 'functions' },         // common usecases
...
;(function()
{
    ...
    function Brush()
    {
        ...
        this.regexList = [
            ...
            { regex: new RegExp(this.getKeywords(funcs), 'gmi'),                css: 'color2' },     // usecases
